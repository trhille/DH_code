...
load min_Hat_E_and_fs.mat
 ...
 E_P = interp1(x_P_min, E_P_min, x_P, 'linear', 'extrap');
 fs_P = interp1(x_P_min, fs_P_min, x_P, 'linear', 'extrap');
 E_P2 = interp1(x_P2_min, E_P2_min, x_P2, 'linear', 'extrap');
 fs_P2 = interp1(x_P2_min, fs_P2_min, x_P2, 'linear', 'extrap');
 
 E_w = interp1(x_w_min, E_w_min, x_w, 'linear', 'extrap');
 E_e = interp1(x_e_min, E_e_min, x_e, 'linear', 'extrap');
 fs_w = interp1(x_w_min, fs_w_min, x_w, 'linear', 'extrap');
 fs_e = interp1(x_e_min, fs_e_min, x_e, 'linear', 'extrap');

 E_w2 = interp1(x_w2_min, E_w2_min, x_w2, 'linear', 'extrap');
 E_e2 = interp1(x_e2_min, E_e2_min, x_e2, 'linear', 'extrap');
 fs_w2 = interp1(x_w2_min, fs_w2_min, x_w2, 'linear', 'extrap');
 fs_e2 = interp1(x_e2_min, fs_e2_min, x_e2, 'linear', 'extrap');



% % --------------------------------------------------------
% % IF running minization for values on edgepoints, use this:
% % --------------------------------------------------------
% 
