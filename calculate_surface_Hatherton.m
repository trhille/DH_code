...
% Guess initial surface...    
   ...
   [ S_P2(time2,:), h_P2(time,:), ...  
    ...
    dS_dx_edges_xt2(time2,:) ] = calc_h_0( x_P2, x_w2, x_e2, dx_P2, B_P2, B_w2, B_e2, ...
                                         ...
                                         sliding_only2, scaling_w2, scaling_e2);
...
flux_edges_kin_xt2(time2,:) = flux_edges_kin_xt2(time2,:) + [flux_add_w2(1) flux_add_e2];
 ...
 flux_edges_dyn_xt2(time2,:) = (flux_edges_dyn_xt2(time2,:) .* [scaling_w2(1) scaling_e2]) + [flux_add_w2(1) flux_add_e2];
...
% keyboard
  ...
  [ h_P2(time2,:), h_w2(time2,:), h_e2(time2,:), ...
   ...
   flux_edges_dyn_xt2(time2,:), kill      ] = surface_main( h_P2(time2-1,:), S_P2(time2-1,:), ...
                                              x_P2, x_w2, x_e2, ...
                                              dx_P2, dx_w2, dx_e2, ...
